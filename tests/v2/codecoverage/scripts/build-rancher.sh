...
CATTLE_KDM_BRANCH=fix-issue-41601
...
curl -sLf https://raw.githubusercontent.com/chiukapoor/kontainer-driver-metadata/${CATTLE_KDM_BRANCH}/data/data.json > tests/v2/codecoverage/bin/data.json